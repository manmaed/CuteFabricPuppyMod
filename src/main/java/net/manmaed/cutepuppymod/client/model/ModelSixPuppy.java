   ...
   /* textureWidth = 64;
    textureHeight = 32;
      ...
      *//*
      ...
      Stick.addBox(3F, 2F, -1F, 1, 1, 6);
      Stick.setRotationPoint(0.5F, 17F, -5F);
      Stick.setTextureSize(64, 32);
      Stick.mirror = true;
      setRotation(Stick, -0.0698132F, -0.1396263F, 0F);
      Ban = new ModelRenderer(this, 26, 17);
      Ban.addBox(2.5F, 0.6F, -4F, 2, 4, 3);
